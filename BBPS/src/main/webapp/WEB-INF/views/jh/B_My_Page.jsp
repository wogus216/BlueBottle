		...
		if($.trim($(".confirm_pw").val()) == ""){
			...
			$.ajax({
				...
				success: function(res){
					...
					if(res.msg == "success"){
						$("#send_form").attr("action","B_My_Page_Edit");
						$("#send_form").submit();
...
function makePopup(title, func) {
	...
	html+= 		"<input type=\"password\" id=\"bPw\" name=\"bPw\" placeholder=\"비밀번호를 입력해주세요\"  class=\"confirm_pw\">";	
	html+= "</div>";	
...
<!-- 본문 -->
	<div class="main_content_area">
		<div class="wrap">
			<div class="left">
				<div class="user_no"><h3>지점 번호</h3></div>
			</div>
			<div class="right">
				<div class="user_no">${data.BNO}</div>
			</div>
		</div>
		<div class="wrap">
			<div class="left">
				<div class="dep_nm"><h3>지점명</h3></div>
			</div>
			<div class="right">
				<div class="dep_nm">${data.BNM}</div>
			</div>
		</div>
		<div class="wrap">
			<div class="left">
		...
		<div class="wrap">
			...
			<div class="right">
				<div class="post_nm">${data.PNUM}</div>
			</div>
		</div>
		<div class="wrap">
			<div class="left">
				<div class="post_nm"><h3>주소</h3></div>
			</div>
			<div class="right">
				<div class="post_nm">${data.DFADDR}</div>
			</div>
		</div>
		<div class="wrap">
			<div class="left">
				<div class="post_nm"><h3>상세주소</h3></div>
			</div>
			<div class="right">
				<div class="post_nm">${data.DTADDR}</div>
			</div>
		</div>
		<div class="wrap">
			<div class="left">
				<div class="user_name"><h3>지점전화번호</h3></div>
			</div>
			<div class="right">
				<div class="user_name">${data.CNUM}</div>
			</div>
		</div>
		<div class="wrap">
			<div class="left">
				<div class="user_name"><h3>지점장명</h3></div>
			</div>
			<div class="right">
				<div class="user_name">${data.MNM}</div>
			</div>
		</div>
		<div class="wrap">
			<div class="left">
				<div class="phone_num"><h3>지점장 휴대폰 번호</h3></div>
			</div>
			<div class="right">
				<div class="phone_num">${data.MGPNUM}</div>
			</div>
		</div>
	</div>
<!-- 버튼 -->
